...
var option = {
	username: "LuongVietTuan",
	password: "12345",
	port: 17619
};

var client = mqtt.connect('mqtt://postman.cloudmqtt.com', option);
...
client.on("message", function (topic, message) {
    ...
    var sql = "INSERT INTO Embedded(temp,hum,time) VALUES("+a.temp+","+a.hum+",'"+time+"')";
...
con.connect(function(err) {
  	con.query("SELECT * FROM Embedded order by id desc limit 10", function (err, result) {
        if(result.length >0){
            for(var i=0; i<10;i++){
