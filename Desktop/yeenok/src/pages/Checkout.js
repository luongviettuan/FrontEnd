...
export default class Checkout extends Component{
  ...
  StepSelect(step) {
    ...
    for(var property in this.state.stepState){  
      if(property == step){
        stepState[property] = true;
      }
      else{
        stepState[property] = false;
      }     
    }
    this.setState({
      stepState : stepState
            ...
            <div class="container">
              <div class="row ">
                ...
                <div id="column-left" class="col-sm-4 col-lg-3 hidden-xs">
                  ...
                  <div class="left_banner left-sidebar-widget mb_50 mt_30"> <a href="#"><img src={require('../public/images/left1.jpg')} alt="Left Banner" class="img-responsive" /></a> </div>
                  ...
                  <div class="row">
                    <div class="col-sm-12">
                      <div class="brand owl-carousel ptb_20">
                        <div class="item text-center"> <a href="#"><img src={require('../public/images/brand/brand1.png')} alt="Disney" class="img-responsive" /></a> </div>
                        <div class="item text-center"> <a href="#"><img src={require('../public/images/brand/brand2.png')} alt="Dell" class="img-responsive" /></a> </div>
                        <div class="item text-center"> <a href="#"><img src={require('../public/images/brand/brand3.png')} alt="Harley" class="img-responsive" /></a> </div>
                        <div class="item text-center"> <a href="#"><img src={require('../public/images/brand/brand4.png')} alt="Canon" class="img-responsive" /></a> </div>
                        <div class="item text-center"> <a href="#"><img src={require('../public/images/brand/brand5.png')} alt="Canon" class="img-responsive" /></a> </div>
                        <div class="item text-center"> <a href="#"><img src={require('../public/images/brand/brand6.png')} alt="Canon" class="img-responsive" /></a> </div>
                        <div class="item text-center"> <a href="#"><img src={require('../public/images/brand/brand7.png')} alt="Canon" class="img-responsive" /></a> </div>
                        <div class="item text-center"> <a href="#"><img src={require('../public/images/brand/brand8.png')} alt="Canon" class="img-responsive" /></a> </div>
                        <div class="item text-center"> <a href="#"><img src={require('../public/images/brand/brand9.png')} alt="Canon" class="img-responsive" /></a> </div>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="footer-top pb_60 mb_30">
                    <div class="col-xs-12 col-sm-6">
                      <div class="footer-logo"> <a href="index.html"> <img src={require('../public/images/footer-logo.png')} alt="OYEENok" /> </a> </div>
                      ...
                      <div class="Testimonial">
                        <div class="client owl-carousel">
                          <div class="item client-detail">
                            <div class="client-avatar"> <img alt="" src={require('../public/images/user1.jpg')} /> </div>
                          ...
                          <div class="item client-detail">
                            <div class="client-avatar"> <img alt="" src={require('../public/images/user2.jpg')} /> </div>
                            <div class="client-title"><strong>joseph Lui</strong></div>
                            <div class="client-designation mb_10"> - php Developer</div>
                            <p><i class="fa fa-quote-left" aria-hidden="true"></i>Lorem ipsum dolor sit amet, volumus oporteat his at sea in Rem ipsum dolor sit amet, sea in odio ..</p>
                          </div>
                          <div class="item client-detail">
                            <div class="client-avatar"> <img alt="" src={require('../public/images/user3.jpg')} /> </div>
                            <div class="client-title"><strong>joseph Lui</strong></div>
                            <div class="client-designation mb_10"> - php Developer</div>
                            <p><i class="fa fa-quote-left" aria-hidden="true"></i>Lorem ipsum dolor sit amet, volumus oporteat his at sea in Rem ipsum dolor sit amet, sea in odio ..</p>
                          </div>
